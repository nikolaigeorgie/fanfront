...
export const createEvent = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    const now = Date.now();
    const maxCapacity = args.maxCapacity || Math.floor(args.maxDuration / args.slotDuration);
...
export const updateEvent = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (args.maxDuration !== undefined) updateData.maxDuration = args.maxDuration;
    if (args.slotDuration !== undefined) updateData.slotDuration = args.slotDuration;
    if (args.maxCapacity !== undefined) updateData.maxCapacity = args.maxCapacity;
    if (args.physicalLineThreshold !== undefined) updateData.physicalLineThreshold = args.physicalLineThreshold;
